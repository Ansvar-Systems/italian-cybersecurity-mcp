...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across ACN guidance documents. Covers Piano Strategico Nazionale per la Cybersicurezza, Misure Minime di Sicurezza, and NIS2 implementation guidance.",
    inputSchema: {
  ...
  },
  {
    ...
    description:
      "Get a specific ACN guidance document by reference (e.g., 'ACN-LN-2023', 'ACN-PSNC-2022').",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "ACN document reference" },
      },
      required: ["reference"],
    },
  },
  {
    ...
    description:
      "Search CSIRT-ITA security advisories and alerts. Returns advisories with severity, affected products, and CVE references.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Get a specific CSIRT-ITA security advisory by reference (e.g., 'CSIRT-IT-ADV-2024-001').",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "CSIRT-ITA advisory reference" },
      },
      required: ["reference"],
    },
  },
